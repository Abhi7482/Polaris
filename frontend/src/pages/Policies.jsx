        ...
        <div className="min-h-screen bg-white text-gray-800 p-8 md:p-16 font-sans leading-relaxed">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex flex-wrap gap-6 justify-center mb-16 border-b border-gray-200 pb-8 sticky top-0 bg-white/95 backdrop-blur py-4 z-10">
                    ...
                    <a href="#return" className="text-blue-600 hover:text-blue-800 hover:underline font-medium transition-colors">Return Policy</a>
                    <a href="#shipping" className="text-blue-600 hover:text-blue-800 hover:underline font-medium transition-colors">Shipping Policy</a>
                </div>
                ...
                <section id="terms" className="mb-20 scroll-mt-24">
                    ...
                    <div className="prose prose-lg text-gray-600 space-y-4">
                        ...
                        <p>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://polaris7482.netlify.app/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</p>
                        <p>The Platform is owned by Polaris, a company incorporated under the Companies Act, 1956 with its registered office at Sanath Apt 402, Shivbasava Nagar, Belgaum, India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').</p>
                        ...
                        <p className="font-bold uppercase">ACCESSING, BROWSING OR OTHERWISE USING THE PLATFORM INDICATES YOUR AGREEMENT TO ALL THE TERMS AND CONDITIONS UNDER THESE TERMS OF USE, SO PLEASE READ THE TERMS OF USE CAREFULLY BEFORE PROCEEDING.</p>
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                            ...
                            <li>You agree to pay us the charges associated with availing the Services. The current charge for a single photobooth session is ₹200 (Indian Rupees Two Hundred Only).</li>
                            ...
                            <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Belgaum and Karnataka.</li>
                ...
                <section id="privacy" className="mb-20 scroll-mt-24">
                    ...
                    <div className="prose prose-lg text-gray-600 space-y-4">
                        ...
                        <h3 className="text-xl font-semibold text-gray-800 mt-6">Sharing</h3>
                        ...
                        <h3 className="text-xl font-semibold text-gray-800 mt-6">Security Precautions</h3>
                        ...
                        <h3 className="text-xl font-semibold text-gray-800 mt-6">Data Deletion and Retention</h3>
                        ...
                        <h3 className="text-xl font-semibold text-gray-800 mt-6">Grievance Officer</h3>
                        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                            <p><strong>Name:</strong> Polaris</p>
                            <p><strong>Designation:</strong> Owner</p>
                            <p><strong>Company:</strong> Polaris</p>
                ...
                <section id="refund" className="mb-20 scroll-mt-24">
                    ...
                    <div className="prose prose-lg text-gray-600 space-y-4">
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                            ...
                            <li>Polaris does not accept cancellation requests for perishable items like flowers, eatables, etc. However, the refund / replacement can be made if the user establishes that the quality of the product delivered is not good.</li>
                            ...
                            <li>In case of any refunds approved by Polaris, it will take 1 days for the refund to be processed to you.</li>
                        </ul>
                    </div>
                </section>
                ...
                <section id="return" className="mb-20 scroll-mt-24">
                    <h2 className="text-3xl font-bold mb-6 text-gray-900 border-b pb-2">Return Policy</h2>
                    <div className="prose prose-lg text-gray-600 space-y-4">
                ...
                <section id="shipping" className="mb-20 scroll-mt-24">
                    <h2 className="text-3xl font-bold mb-6 text-gray-900 border-b pb-2">Shipping Policy</h2>
                    <div className="prose prose-lg text-gray-600 space-y-4">
